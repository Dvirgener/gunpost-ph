            ...
            @if ($profile->verification->submitted_at)
                ...
                <div>
                    ...
                    <div class="mb-5 md:flex items-center gap-3 space-y-2">
                        ...
                        <flux:heading>Goverment ID type Uploaded - ({{ $profile->verification->government_id_type }})
                    ...
                    <div>
                        <flux:heading size="lg" class="font-mono text-start my-2 font-bold">SELFIE WITH GOVERNMENT
                            ID
                        </flux:heading>
