    ...
    <div class="flex-1 min-h-0 overflow-y-scroll px-2">
        <form action="" wire:submit="save" class="space-y-4">
            <flux:accordion>
                ...
                {{-- Ammunition specs --}}
                <flux:accordion.item expanded>
                    <flux:accordion.heading class="text-blue-500! mb-3">Ammunition specifications
                    </flux:accordion.heading>
                    <flux:accordion.content>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <flux:field>
                    ...
                    <flux:accordion.content>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <flux:field>
                                ...
                                <flux:input type="number" wire:model.live="rounds_per_box"
                                    placeholder="e.g., 100" />
                ...
                {{-- Condition & special --}}
                <flux:accordion.item>
                    <flux:accordion.heading class="text-blue-500! mb-3">Condition & special flags
                    </flux:accordion.heading>
                    <flux:accordion.content>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <flux:field>
