            ...
            <flux:accordion>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <flux:field class="md:col-span-2">
                                ...
                                <flux:input wire:model.live="title"
                                    placeholder="e.g., Custom Bowie Knife, Samurai Sword" />
                    ...
                    <flux:accordion.content>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <flux:field>
                                ...
                                <flux:input wire:model.live="subcategory"
                                    placeholder="e.g., karambit, bowie, katana" />
                    ...
                    <flux:accordion.content>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <flux:field>
                                ...
                                <flux:input wire:model.live="blade_type"
                                    placeholder="e.g., fixed, folding, serrated" />
                            ...
                            <div class="flex items-center gap-2">
                                <flux:switch wire:model.live="full_tang" />
                    ...
                    <flux:accordion.content>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <flux:field>
                                ...
                                <flux:input wire:model.live="handle_material"
                                    placeholder="e.g., g10, micarta, wood" />
                ...
                <flux:accordion.item>
                    ...
                    <flux:accordion.content>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="flex items-center gap-2">
                                <flux:switch wire:model.live="is_folding" />
                                <flux:label>Is folding</flux:label>
                            </div>
                            <flux:field>
                                <flux:label>Opening mechanism</flux:label>
                                <flux:input wire:model.live="opening_mechanism"
                                    placeholder="e.g., manual, assisted" />
                ...
                <flux:accordion.item>
                    ...
                    <flux:accordion.content>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="flex items-center gap-2">
                                <flux:switch wire:model.live="includes_sheath" />
